...
public static class GameDataSerializer
{
    ...
    public static UserPrefData _userData;
    ...
    /// <summary>
    /// Saves the current User Preference Data
    /// </summary>
    public static void SaveUserPrefData(UserPrefData data)
    {
        if (_userData == null)
        {
            _userData = data;
            Debug.Log("Created new UserPrefData!");
        }
        else
        {
            _userData = data;
            Debug.Log("Updated UserPrefData!");
        }
    }
